...
public class GpuVoltEditor {
    ...
    public static void decode() throws Exception {
        ...
        while (++i < lines_in_dts.size()) {
            ...
            } else if (ChipInfo.which == ChipInfo.type.lito_v1 || ChipInfo.which == ChipInfo.type.lito_v2 || ChipInfo.which == ChipInfo.type.lagoon || ChipInfo.which == ChipInfo.type.khaje) {
