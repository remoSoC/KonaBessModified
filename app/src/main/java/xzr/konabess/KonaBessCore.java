...
public class KonaBessCore {
    ...
    public static void cleanEnv(Context context) throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to clean environment", e);
        } finally {
            process.destroy();
        }
    }
    ...
    public static void reboot() throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to reboot", e);
        } finally {
            process.destroy();
        }
    }
    ...
    private static void getRealBootImage(Context context) throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to get real boot image", e);
        } finally {
            process.destroy();
        }
        ...
        if (!target.exists() || !target.canRead()) {
            target.delete();
            throw new IOException("Boot image not found or not readable");
        }
    }
    ...
    private static void getVendorBootImage(Context context) throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to get vendor boot image", e);
        } finally {
            process.destroy();
        }
        ...
        if (!target.exists() || !target.canRead()) {
            target.delete();
            throw new IOException("Vendor boot image not found or not readable");
        }
    }
    ...
    public static void writeBootImage(Context context) throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to write boot image", e);
        } finally {
            process.destroy();
        }
    }
    ...
    public static void backupBootImage(Context context) throws IOException {
        ...
        try (BufferedReader bufferedReader =
            ...
            e.printStackTrace();
            throw new IOException("Failed to backup boot image", e);
        } finally {
            process.destroy();
        }
    }
